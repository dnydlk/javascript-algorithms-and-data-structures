...
const renderSongs = (array) => {
  const songsHTML = array // allSongs
    .map((song) => {
      return `
    ...
    .join("") // to get rid of the commas in the array

  playlistSongs.innerHTML = songsHTML // allSongs
}
...
const playNextSong = () => {
  ...
  // if (getCurrentSongIndex !== userData?.songs.length) {
  //   playSong(getCurrentSongIndex + 1)
  // }
}
const playPreviousSong = () => {
  ...
  // if (getCurrentSongIndex !== 0 && userData?.songs.length > 1) {
  //   playSong(getCurrentSongIndex - 1)
  // }
}
